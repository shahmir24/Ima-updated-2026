...
/** Five rhythm cards, each carrying four lines of text: two columns suit
 *  them better than three cramped ones. */
...
const BreathingMenu = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground pb-20 lg:pb-10">
      <PageHeader title="Pick Your Rhythm" backPath="/wellness" width={WORKSPACE} />

      <main className="flex-1">
        <PageWorkspace width={WORKSPACE} className="space-y-4 sm:space-y-6">
          ...
          <div className="mt-6 sm:mt-8 lg:mx-auto lg:max-w-3xl bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-3xl p-4 sm:p-6">
